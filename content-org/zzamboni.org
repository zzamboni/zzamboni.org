...
:export_hugo_custom_front_matter: :finalURL https://leanpub.com/utileras-unix
:END:
...
*** DONE New book: Literate Config
CLOSED: [2019-11-18 Mon 22:44]
:PROPERTIES:
:export_hugo_bundle: 2019-11-18-new-book-literate-config
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featured_image /images/literate-config-cover.png
:END:
#+begin_description
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc false :featured_image /images/utilerias-cover.png
:END:
#+begin_description
...
Puedes obtener más información, leer una muestra gratuita y comprarlo  en  [[https://leanpub.com/utileras-unix][LeanPub]].

{{< utileriasbookimglink >}}

¡Espero lo disfrutes!  Favor de enviarme tus comentarios a través de  la  página  [[https://leanpub.com/utileras-unix/email_author/new][/Escribe al Autor/]] en LeanPub.
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc true :featured_image /images/hammerspoon-github-circleci-leanpub.001.png
:END:
...
file:images/hammerspoon-github-circleci-leanpub-transp.png
