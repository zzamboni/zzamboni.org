...
:export_hugo_custom_front_matter: :featured_image /images/doom-emacs-color.png :toc true
:END:
#+begin_description
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featured_image /images/emacs-org-leanpub-cover.png
:END:
#+begin_description
