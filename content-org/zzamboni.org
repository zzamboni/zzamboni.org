...
** TODO Reviving an old Mac with Linux (part 2 - prettifying boot)
:PROPERTIES:
...
1. Make sure the OpenCore EFI partition is mounted. It should normally be =/dev/sda1=. Depending on how you installed Linux, it may already be mounted as =boot/efi=. If you installed Elementary OS and created a second EFI partition, you'll need to explicitly mount it:
   #+begin_src bash
