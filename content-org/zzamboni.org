...
- [[#posts][Posts]]
  ...
  - [[#other][Other]]
    - [[#my-blogging-setup-and-workflow-with-emacs-org-mode-ox-hugo-hugo-gitlab-and-netlify][My blogging setup and workflow with Emacs, Org mode, ox-hugo, Hugo, GitLab and Netlify]]
...
- *What:* :: I work as Enterprise Security Architect in the IT Clouds Division of [[http://swisscom.com/][Swisscom]]. I am also the author of [[http://cf-learn.info]["Learning CFEngine"]] and [[https://leanpub.com/learning-hammerspoon]["Learning Hammerspoon"]].
...
#+include: "~/.emacs.d.mine/init.org" :lines "19-"
...
*** DONE How to insert screenshots in Org documents on macOS :orgmode:emacs:howto:macos:config:
...
*** DONE August 2020 release of "Learning Hammerspoon" is out! :book:announcement:
...
*** DONE My blogging setup and workflow with Emacs, Org mode, ox-hugo, Hugo, GitLab and Netlify :blogging:howto:emacs:hugo:orgmode:gitlab:
...
*** DONE New release of /Publishing with Emacs, Org-mode and Leanpub/ :book:leanpub:publishing:writing:emacs:orgmode:
...
*** DONE New book: Publishing with Emacs, Org-mode and Leanpub :book:leanpub:publishing:writing:emacs:orgmode:
...
*** DONE New book: Literate Config :literateconfig:book:leanpub:literateprogramming:
...
*** DONE Nuevo libro "Utilerías de Unix" :book:announcement:spanish:unix:linux:leanpub:
