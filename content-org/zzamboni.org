...
These are produced by a [[/post/using-spoons-in-hammerspoon/][Spoon]] I wrote called [[https://www.hammerspoon.org/Spoons/Leanpub.html][Leanpub]]. You can install, load and configure it using the [[/post/using-spoons-in-hammerspoon/#automated-spoon-installation-and-configuration][SpoonInstall]] spoon. For example, in my configuration I have [[/post/my-hammerspoon-configuration-with-commentary/#leanpub-integration][the following code]] to configure the spoon to watch for both of my books:
