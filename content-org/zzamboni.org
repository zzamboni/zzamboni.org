...
- [[#pages][Pages]]
  ...
  - [[#books-section][Books section]]
    ...
    - [[#utilerías-de-unix][Utilerías de Unix]]
    - [[#literate-config][Literate Config]]
    - [[#publishing-with-emacs-org-mode-and-leanpub][Publishing with Emacs, Org-mode and Leanpub]]
    - [[#course-cissp-training][Course: CISSP Training]]
  - [[#code-section][Code section]]
    - [[#code][Code]]
    - [[#ox-leanpub][ox-leanpub]]
    - [[#enwrite][Enwrite]]
    - [[#grabcartoons][GrabCartoons]]
    - [[#resume-toolkit][resume-toolkit]]
    - [[#jsonresume-theme-eventide][jsonresume-theme-eventide]]
- [[#ideas][Ideas]]
  - [[#enabling-menubar-indicators-in-elementary-os][Enabling menubar indicators in Elementary OS]]
  - [[#how-to-set-up-copyq-in-eos-with-wayland][How to set up CopyQ in eOS with Wayland]]
  - [[#networking-related-setup][Networking-related setup]]
- [[#posts][Posts]]
  ...
  - [[#other][Other]]
    ...
    - [[#nuevo-libro-utilerías-de-unix][Nuevo libro "Utilerías de Unix"]]
    ...
    - [[#reviving-an-old-mac-with-linux-part-1---installing-linux][Reviving an old Mac with Linux (part 1 - installing Linux)]]
    - [[#reviving-an-old-mac-with-linux-part-2---prettifying-boot][Reviving an old Mac with Linux (part 2 - prettifying boot)]]
    - [[#website-redesign][Website redesign!]]
    - [[#fixing-wake-from-sleep-in-linux-on-a-mac-when-using-ethernet][Fixing wake-from-sleep in Linux on a Mac when using Ethernet]]
    - [[#locally-hosting-my-twitter-archive][Locally hosting my Twitter archive]]
    - [[#porting-my-cv-from-orglatex-to-json-resume][Porting my CV from Org+LaTeX to JSON Resume]]
    - [[#resume-toolkit-from-personal-cv-pipeline-to-reusable-toolkit][resume-toolkit: from personal CV pipeline to reusable toolkit]]
    - [[#vivaldi-browser-configuration-in-linux][Vivaldi browser configuration in Linux]]
    - [[#when-a-local-timestamp-pretends-to-be-utc][When a local timestamp pretends to be UTC]]
...
** DONE About
CLOSED: [2025-11-17 Mon 16:28]
:PROPERTIES:
:export_hugo_section: about
:export_hugo_custom_front_matter: :featureimage img/legoland.jpg :showPagination false :layout profile :showDate false :showWordCount false :showReadingTime false :showAuthor false :showZenMode false
...
You can find my full [[file:/vita][Curriculum Vitae]], also in [[/vita/zamboni-vita.pdf][PDF format]].

*** About this site

This entire site is generated by [[http://gohugo.io][Hugo]] and served by [[https://www.netlify.com/][Netlify]].

The source is stored in my [[https://gitlab.com/zzamboni/zzamboni.org][zzamboni/zzamboni.org]] GitLab repository.  I use [[https://ox-hugo.scripter.co/][ox-hugo]] to generate the content from [[https://github.com/zzamboni/zzamboni.org/blob/master/content-org/zzamboni.org][a single source file]] in [[https://orgmode.org/][org-mode]] format, although all the older articles and pages are still stored in their original source Markdown files (I gradually convert them whenever I update them). Some of my [[file:/code][project]] pages are stored in the =gh-pages= branch of their own GitHub repositories. You can read more about my setup here: [[#my-blogging-setup-with-emacs--org-mode--ox-hugo--hugo--gitlab-and-netlify][My blogging setup with Emacs, Org mode, ox-hugo, Hugo, GitLab and Netlify]].

I think it's incredible that all of this infrastructure is so easy to use and available for free.

*** My online past

- 2008-2024 (Twitter): :: I was on Twitter fairly early (created my account in 2007, though my first tweet is from January 2008), and although I was never a super prolific user, I used it regularly for about 15 years, until its decline after its acquisition and conversion to X. My account is still there so that my username cannot be reused, but my posts are protected. You can find an archive of my tweets in this site: https://zzamboni.org/twitter/ courtesy of [[https://github.com/tweetback/tweetback][Tweetback]]. I'm on Bluesky these days, though I don't post too much.
- 2009-2016: :: During this time my blog went through several iterations, hosted/powered by [[http://www.posterous.com/][Posterous]], [[https://jekyllrb.com/][Jekyll]], [[http://octopress.org/][Octopress]], [[https://postach.io/site][Postach.io]] and [[https://github.com/zzamboni/enwrite][Enwrite]]. Most blog entries from this period have been merged into [[/][my current blog]];
...
- 1997-2001: :: My hand-maintained [[http://homes.cerias.purdue.edu/~zamboni/][web page at Purdue University]] ([[/cerias/zamboni/][here's a mirror]] in case it disappears).
...
- [[https://www.pexels.com/photo/alphabet-board-game-bundle-close-up-278888/][Scrabble letters]] ([[/post][Blog]] background) and [[https://www.pexels.com/photo/brown-paper-tag-lot-1111315/][Tags]] ([[/tags][Tags]] background) from [[https://www.pexels.com/][Pexels]], licensed under [[https://www.pexels.com/photo-license/][CC0]].
- [[/vita][Curriculum Vitae]] background image is generated by OpenAI's [[https://sora.chatgpt.com/g/gen_01kajtzyfdfvdbv6pzzb4ec9hb][Sora]].
...
:export_hugo_custom_front_matter: :featureimage img/phone-booth-red.jpg :showPagination false :showDate false  :showWordCount false :showReadingTime false :showZenMode false
:export_file_name: index
:CUSTOM_ID: contact
:END:
...
:export_hugo_custom_front_matter: :featureimage img/book-box-thin.jpg
:END:
...
:export_hugo_custom_front_matter:  :featureimage img/book-box-thin.jpg :groupByYear false :cardView true :orderByWeight true :cascade '((showReadingtime . false) (showWordCount . false) (showDate . false) (showHero . true) (showSummary . true))'
:ID:       10a2de74-6cdc-4368-abc7-5186eb6e52d5
:END:

I have a few self-published books and courses, all of them available at [[https://leanpub.com/u/zzamboni][{{{icon(leanpub)}}} Leanpub]].

*** DONE Book bundle
CLOSED: [2025-11-17 Mon 19:22]
:PROPERTIES:
:export_hugo_section: book
:export_file_name: book-bundle
:export_hugo_custom_front_matter: :externalURL https://leanpub.com/b/diego :featureimage img/book-bundle-cover.png :weight 10
:END:

You can get each book individually, or get them all as a [[https://leanpub.com/b/diego][bundle]]!
...
:export_hugo_custom_front_matter: :externalURL http://cf-learn.info/ :featureimage img/learning-cfengine3-cover.png :weight 20
:END:

{{{leanpubbook(learning-cfengine,style="float:right" height=340)}}}

The best book for learning [[http://cfengine.com/][CFEngine]]!
...
:export_hugo_custom_front_matter: :externalURL https://leanpub.com/learning-hammerspoon/ :featureimage img/learning-hs-cover.png :weight 30
:END:

{{{leanpubbook(learning-hammerspoon,style="float:right")}}}

*Automate all the things!* From window manipulation to automated system settings depending on your current location, [[http://www.hammerspoon.org/][Hammerspoon]] makes it possible. 
...
*** DONE Utilerías de Unix
CLOSED: [2019-08-30 Tue 00:05]
:PROPERTIES:
:export_hugo_section: book
:export_file_name: utilerias-unix
:export_hugo_custom_front_matter: :externalURL https://leanpub.com/utilerias-unix :featureimage img/utilerias-cover.jpg :weight 70
:END:
...
:export_hugo_custom_front_matter: :externalURL https://leanpub.com/lit-config/ :featureimage img/literate-config-cover.png :weight 40
:END:
...
:export_hugo_custom_front_matter: :externalURL https://leanpub.com/emacs-org-leanpub :featureimage img/emacs-org-leanpub-cover.png :weight 50
:END:
...
*** DONE Course: CISSP Training
CLOSED: [2021-01-21 Thu 00:16]
:PROPERTIES:
:export_file_name: cissp-training
:export_hugo_custom_front_matter: :toc false :featureimage img/cissp-training-cover.jpg :weight 60
:END:
...
[[https://leanpub.com/c/cissp-training?lng=en][CISSP Training: Prepare to pass the CISSP!]]

** DONE Code section
CLOSED: [2018-03-25 Sun 20:11]
:PROPERTIES:
:export_hugo_section: code
:export_hugo_custom_front_matter: :featureimage img/c64-code3.png
:END:
...
:PROPERTIES:
:export_file_name: _index
:export_hugo_custom_front_matter: :featureimage img/c64-code4.png :groupByYear false :orderByWeight true :cardView true :cascade '((showReadingtime . false) (showWordCount . false) (showDate . false) (showHero . true) (showSummary . true))'
:END:
...
:PROPERTIES:
:export_hugo_custom_front_matter: :externalURL https://github.com/zzamboni/ox-leanpub
...
A [[https://leanpub.com/][Leanpub]] book exporter for Org mode. Allows writing the book entirely in Org mode, and generates the Leanpub manuscript. I use this package to publish [[https://leanpub.com/u/zzamboni][my books]].
...
:PROPERTIES:
:export_hugo_custom_front_matter: :externalURL https://github.com/zzamboni/enwrite
:export_file_name: enwrite
:export_hugo_weight: 04
:END:
...
:PROPERTIES:
:export_hugo_custom_front_matter: :externalURL https://github.com/zzamboni/grabcartoons/ :aliases /grabcartoons
...
*** DONE resume-toolkit
CLOSED: [2026-03-31 Tue 20:05]
:PROPERTIES:
:export_hugo_custom_front_matter: :externalURL https://github.com/zzamboni/resume-toolkit/
:export_file_name: resume-toolkit
:export_hugo_weight: 01
:CUSTOM_ID: resume-toolkit
:END:

A tool for exporting JSON Resume (and optionally, BibTeX files) into HTML and PDF formats.

*** DONE jsonresume-theme-eventide
CLOSED: [2026-03-31 Tue 20:30]
:PROPERTIES:
:export_hugo_custom_front_matter: :externalURL https://github.com/zzamboni/jsonresume-theme-eventide
:export_file_name: jsonresume-theme-eventide
:export_hugo_weight: 02
:END:

A JSON Resume theme, derived from [[https://github.com/rbardini/jsonresume-theme-even][jsonresume-theme-even]], with new features like Table of Contents, section reordering and custom labels, certificate and organization logos, and much more. This is the theme used by  [[https://github.com/zzamboni/resume-toolkit][resume-toolkit]].
...
** TODO Enabling menubar indicators in Elementary OS
:PROPERTIES:
:export_hugo_bundle: 2025-11-04-enabling-menubar-indicators-in-elementary-os
:export_file_name: index
:custom_id: enabling-menubar-indicators-in-elementary-os
...
https://github.com/barunespadhy/wingpanel-indicator-appicontray
<write here>
** TODO How to set up CopyQ in eOS with Wayland
:PROPERTIES:
:export_hugo_bundle: 2025-11-04-how-to-set-up-copyq-in-eos-with-wayland
:export_file_name: index
:custom_id: how-to-set-up-copyq-in-eos-with-wayland
:export_hugo_custom_front_matter: :featureimage img/tram-zurich.jpg :toc false
:END:
#+BEGIN_DESCRIPTION
...
<write here>
** TODO Networking-related setup
:PROPERTIES:
:export_hugo_bundle: 2025-11-06-networking-related-setup
:export_file_name: index
:custom_id: networking-related-setup
:export_hugo_custom_front_matter: :featureimage img/tram-zurich.jpg :toc false
:END:
#+BEGIN_DESCRIPTION
Various network-related configuration tips for eOS.
#+END_DESCRIPTION
...
:export_file_name: index
:export_hugo_custom_front_matter: :featureimage img/doom-emacs-color.jpg :toc true
:export_hugo_custom_front_matter+: :series '("Literate Config Files")' :series_order 1
...
:export_file_name: index
:export_hugo_custom_front_matter: :featureimage img/emacs-logo.svg :toc true :aliases /post/2017-12-17-my-emacs-configuration-with-commentary
:export_hugo_custom_front_matter+: :series '("Literate Config Files")' :series_order 2
:END:
#+begin_description
...
:export_hugo_custom_front_matter: :toc true :featureimage img/hammerspoon.jpg
:export_hugo_custom_front_matter+: :series '("Literate Config Files")' :series_order 3
:END:
#+begin_description
...
:export_hugo_custom_front_matter: :toc true :featureimage img/elvish-logo.svg
:export_hugo_custom_front_matter+: :series '("Literate Config Files")' :series_order 4
:END:
#+begin_description
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featureimage img/org-mode-unicorn.svg
:END:
#+begin_description
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc true :featureimage img/emacs-logo.svg :showComments true
:END:
#+begin_description
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc false :featureimage img/emacs-logo.svg :showComments true
:END:
#+begin_description
...
1. Capture screenshot using the macOS built-in screenshot tool ({{{keys(Shift ⌘ 5)}}}) and leave it in the clipboard.
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc true :featureimage img/lua-logo.svg
:END:
#+begin_description
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc false :featureimage img/hammerspoon.jpg
:END:
#+begin_description
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc false :featureimage img/learning-hs-cover.jpg
:END:
#+begin_description
...
:PROPERTIES:
:export_hugo_custom_front_matter: :featureimage img/elvish-logo.svg
:END:
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featureimage img/cissp-training-cover.jpg
:END:
#+begin_description
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc true :featureimage img/z-favicon-src.png
:CUSTOM_ID: my-blogging-setup-with-emacs--org-mode--ox-hugo--hugo--gitlab-and-netlify
:END:
#+begin_description
...
*Update:* I am now using [[https://blowfish.page/][Blowfish]], see [[#website-redesign][Website redesign!]]
#+end_tip
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featureimage img/emacs-org-leanpub-cover.jpg
:END:
#+begin_description
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc false :featureimage img/literate-config-cover.jpg
:END:
#+begin_description
...
*** DONE Nuevo libro "Utilerías de Unix" :books:announcements:spanish:unix:linux:leanpub:
CLOSED: [2019-08-30 Fri 00:23]
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: 2019-08-30-primera-edicion-utilerias-unix
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc false :featureimage img/utilerias-cover.jpg
:END:
#+begin_description
...
Puedes obtener más información, leer una muestra gratuita y comprarlo  en  [[https://leanpub.com/utilerias-unix][LeanPub]].

¡Espero lo disfrutes!  Favor de enviarme tus comentarios a través de  la  página  [[https://leanpub.com/utilerias-unix/email_author/new][/Escribe al Autor/]] en LeanPub.
...
:EXPORT_FILE_NAME: index
:export_hugo_custom_front_matter: :toc true :featureimage img/hammerspoon-github-circleci-leanpub.001.jpg
:END:
...
:export_file_name: index
:export_hugo_custom_front_matter: :toc true :featureimage img/ghost-plus-github2.png :slug hosting-a-ghost-blog-in-github
:END:
#+begin_description
...
:export_hugo_custom_front_matter: :featureimage img/z-favicon-src.png
:CUSTOM_ID: the-big-website-reboot
:END:
#+begin_description
...
The road hasn't been a straight line. I started with [[https://ubuntu.com/][Ubuntu]] 25.04, which I thought was the safest way to go given its popularity. I used it with [[https://omakub.org/][Omakub]], which provides a great starting point. However I decided to keep experimenting. I briefly tried [[https://system76.com/pop/][Pop!_OS]], which is very nice, but eventually landed on [[https://elementary.io/][elementary OS]], which feels highly polished, works great, and reminds me a lot of macOS. It's also based on Ubuntu, so most packages work. I kept my machine as dual-boot with macOS in case I ever need it, but so far I've remained firmly on the Linux side and don't regret it.

Here are some screenshots to wet your appetite: my current dual-boot OpenCore boot screen and my custom [[https://github.com/zzamboni/mac-like][mac-like]] boot theme for Elementary.

[[file:images/20251001-230259_OC-dual-boot-screen.png][file:images/20251001-230259_OC-dual-boot-screen.png]]

[[file:images/20251001-231342_eOS-mac-like-boot.png][file:images/20251001-231342_eOS-mac-like-boot.png]]
...
**** Step 1: Back up, clean up and repartition macOS
...
After this, the first step was to free enough space on macOS so I could resize its disk and leave a chunk of disk empty for my Linux partition. I used the excellent [[https://daisydiskapp.com/][DaisyDisk]] for this, but there are a number of other utilities that can help you identify where the space is going. Fire at will. In my 500GB disk, I managed to reduce my usage to below 300GB on macOS, which allowed me to create a 200GB partition for Linux.
...
If you had [[https://dortania.github.io/OpenCore-Legacy-Patcher/POST-INSTALL.html#booting-seamlessly-without-boot-picker][disabled the boot picker in OCLP]], make sure to reenable it again, it will make it easier to see what's happening when you dual-boot the machine through OpenCore.
...
- In most Linux installers, you will need to identify the EFI partition where the boot components will be stored. Ubuntu allows you to use the existing macOS/OpenCore boot partition, which is 200MB in size. Elementary OS however, requires its EFI partition to be at least 1GB in size, and will not let you choose a smaller partition. Fortunately, OpenCore automatically knows how to handle multiple EFI partitions, so you can just create an extra 1GB EFI partition in your free space, use it for Elementary, and leave the rest for the main Linux partition. It looks like this in GParted (=dev/sda1= was the preexisting EFI partition, =dev/sda3= is the one I created for installing Elementary):
  ...
  [[file:images/20251005-000848_eOS-Gparted-extra-EFI-partition.png][file:images/20251005-000848_eOS-Gparted-extra-EFI-partition.png]]

- After the Linux installation finishes, try rebooting. In principle, you should see the OpenCore boot screen. However, in my case OpenCore refused to identify the Linux partitions. After *a lot* of head banging I figured out the solution: The trick was to manually install the latest [[https://github.com/acidanthera/OpenCorePkg/releases/][OpenCore release]] into the EFI partition, overwriting the existing BOOT and OC directories (make sure you back them up first!). You can do this either from macOS if it boots, or from the Linux USB installer. Then OpenCore automatically detected and correctly booted both Linux and macOS. Once everything works, you should see something like this:

  [[file:images/20251013-223325_eOS-default-OpenCore-boot.png][file:images/20251013-223325_eOS-default-OpenCore-boot.png]]
...
In the [[#reviving-an-old-mac-with-linux-part-2-prettifying-the-boot-screens][next post]] in this series we will look into making the boot screen prettier.


*** DONE Reviving an old Mac with Linux (part 2 - prettifying boot) :howto:mac:linux:opencore:oclp:
CLOSED: [2025-10-18 Sat 20:24]
:PROPERTIES:
:export_hugo_bundle: 2025-10-14-reviving-an-old-mac-with-linux-part-2-prettifying-the-boot-screens
:export_file_name: index
:custom_id: reviving-an-old-mac-with-linux-part-2-prettifying-the-boot-screens
:export_hugo_custom_front_matter: :featureimage img/20251001-230259_OC-dual-boot-screen.png :toc true
:export_hugo_custom_front_matter+: :series '("Linux on Mac")' :series_order 2
:END:
...
In the [[#reviving-an-old-mac-with-linux-part-1][previous post]], we saw the steps to install Linux in a dual-boot setup on an old Mac, using OpenCore as the boot manager.
...
#+DOWNLOADED: file:images/20251013-223325_eOS-default-OpenCore-boot.png @ 2025-10-18 09:16:14
[[file:images/20251013-223325_eOS-default-OpenCore-boot.png][file:images/20251013-223325_eOS-default-OpenCore-boot.png]]

**** Prettifying the OpenCore boot screen

The [[https://dortania.github.io/OpenCore-Install-Guide/][OpenCore]] boot loader "is a complex piece of software" (in its own words). It's extensively documented but works reasonably well with defaults. You may need to refer to its [[https://dortania.github.io/docs/][Configuration guide]] for most advanced use cases. For what we want here, see [[https://dortania.github.io/OpenCore-Post-Install/cosmetic/gui.html#setting-up-opencore-s-gui][OpenCore beauty treatment]], but I've extracted the main steps below.

First, we can configure the OpenCore theme. You can find links to many nice themes at [[https://dortania.github.io/OpenCanopy-Gallery/][OpenCanopy Gallery]]. The [[https://dortania.github.io/OpenCanopy-Gallery/ocbinary.html][Acidanthera themes]] are included with OpenCore, but I personally like the [[https://dortania.github.io/OpenCanopy-Gallery/blackosx.html#themes][Blackosx themes]]. The one I'm currently using is [[https://github.com/blackosx/BsxDarkFenceLight1][BsxDarkFenceLight1]]. Here's how to install and configure a theme:
...
5. Reboot! You should now see the new theme in action, but still with the extra icons, and with the default Penguin icon for Linux:
  [[file:images/20251013-232121_09205826.png]]
...
**** Prettifying the Linux boot screen.

Most Ubuntu-based distributions (and maybe others) these days use [[https://wiki.ubuntu.com/Plymouth#Splash_Theme][Plymouth]] as their boot-screen manager. Plymouth is a bit of a dark art - it's somewhat documented but a lot of trial and error is still needed. In elementary OS, by default you will see the following boot screen:

#+DOWNLOADED: file:///home/diego/Pictures/Screenshots/eOS-plymouth-boot.png @ 2025-10-18 18:03:13
[[file:images/20251018-180313_eOS-plymouth-boot.png][file:images/20251018-180313_eOS-plymouth-boot.png]]
...
#+DOWNLOADED: file:///home/diego/tmp/mac-like-boot-eos.png @ 2025-10-18 18:05:10
[[file:images/20251018-180510_mac-like-boot-eos.png][file:images/20251018-180510_mac-like-boot-eos.png]]

And here's how to achieve it:

1. Clone the [[https://github.com/zzamboni/mac-like][mac-like]] repository:
  #+begin_src bash
...
sudo cp -a mac-like /usr/share/plymouth/themes/
  #+end_src
3. The theme comes with the elementary OS logo by default. If you want to change it, you need to replace the =header-image.png= file with the logo you want to use. You can use whatever logos you want. What I did was to reuse the logos from the OpenCore theme (for example, my eOS logo comes from [[https://github.com/blackosx/BsxDarkFenceLight1][BsxDarkFenceLight1]], before I was using the Ubuntu logo from the same theme). The OpenCore icons include the logos in Apple's ICNS format, but Plymouth expect the images in PNG, so you need to convert it. You can do it locally with something like Gimp, or online. For example, I have used https://www.coolutils.com/online/ICNS-to-PNG and it works well. Once you have your logo converted, copy it to =/usr/share/plymouth/themes/header-image.png=.
...
*** DONE Website redesign! :sitenews:announcements:
CLOSED: [2025-11-18 Tue 13:37]
:PROPERTIES:
:export_hugo_bundle: 2025-11-17-website-redesign
:export_file_name: index
:custom_id: website-redesign
:export_hugo_custom_front_matter: :featureimage img/z-favicon-src.png :toc false
:END:

Eight years ago I announced [[#the-big-website-reboot][The Big Website Reboot]], when I switched my website to Hugo. I'm happy to announce the first major update since then.

#+hugo: more

Since then, I've been using the Hugo [[https://ananke-theme.netlify.app/][Ananke]] theme, which is very nice and powerful. Over time, I made adjustments not only to the configuration but also to the theme itself. Due to my lack of experience with Hugo, I failed to separate my changes from the upstream theme, which has made it difficult to upgrade to new versions. While my website was still functional, it felt a bit kludged together under the hood, and it was hard to make any changes, so I decided a major overhaul was needed.

I considered many possibilities, from upgrading Ananke itself or various other Hugo themes, including [[https://themes.gohugo.io/themes/congo/][Congo]], [[https://themes.gohugo.io/themes/hugo-papermod/][Papermod]] and [[https://hugo-tufte.netlify.app/][Tufte]]. In the end I decided on [[https://blowfish.page/][Blowfish]]. I liked that it's extensively documented, very flexible and with many nice built-in features, including search, code highlighting, support for article series, and much more.
...
Please take a look! Please [[/contact][let me know]] if you find anything broken.


*** DONE Fixing wake-from-sleep in Linux on a Mac when using Ethernet :linux:howto:mac:networking:troubleshooting:
CLOSED: [2025-10-22 Wed 23:28]
:PROPERTIES:
:export_hugo_bundle: 2025-10-22-fixing-wake-from-sleep-when-using-ethernet
:export_file_name: index
:custom_id: fixing-wake-from-sleep-when-using-ethernet
:export_hugo_custom_front_matter:  :toc false :featureimage img/generated/2025-10-22-fixing-wake-from-sleep-when-using-ethernet.webp
:export_hugo_custom_front_matter+: :series '("Linux on Mac")' :series_order 3
:END:
#+begin_description
...
I noticed that after being asleep, my [[#reviving-an-old-mac-with-linux-part-1][2015 MBP running Linux]] would not wake up if it had an Ethernet cable connected when it went to sleep. With some help from ChatGPT I learned that this seems to be a known problem on some Macs in which the Thunderbolt controller doesn’t resume cleanly, leaving the system stuck in a low-level power state — which effectively hangs the resume process.
...
*** DONE Locally hosting my Twitter archive :sitenews:
CLOSED: [2025-10-24 Fri 23:29]
:PROPERTIES:
:export_hugo_bundle: 2025-10-24-twitter-archive-online
:export_file_name: index
:custom_id: twitter-archive-online
:export_hugo_custom_front_matter: :featureimage img/i-will-be-in-bluesky.jpg :toc false
:END:
...
I've had a Twitter account (sorry, I refuse to call it X) since 2007 (though my [[https://zzamboni.org/twitter/648153912/][first tweet]] was in January 2008). I was never super prolific, but I enjoyed using it even as it started going downhill with noise, trolls and advertising. Its sale in 2022 was the beginning of the end. In October 2024 I posted my [[https://zzamboni.org/twitter/1848357411301515531/][last tweet]] (#5,051!). I have mostly dropped out of social media, but now I have a [[https://bsky.app/profile/zzamboni.org][Bluesky account]]. Although Bluesky has also seem some growing pains, it still reminds me a lot of Twitter in the early days, in which community and interaction was more important than marketing and provocation.

#+DOWNLOADED: file:///home/diego/tmp/i-will-be-in-bluesky.jpg @ 2025-10-24 22:44:29
[[file:images/20251024-224429_i-will-be-in-bluesky.jpg][file:images/20251024-224429_i-will-be-in-bluesky.jpg]]

(image courtesy of [[https://bsky.app/profile/davis.social/post/3latz2nsm2s2f][@davis.social]])

My Twitter account is now protected, but I decided to keep a [[https://zzamboni.org/twitter/][local archive of my tweets]], to which the Twitter icon in the header/footer in my website now points. I used the excellent [[https://github.com/tweetback/tweetback][tweetback]] to create this archive. It's a great tool and very easy to use, and I love the look of the archive. Check it out?
...
*** DONE Porting my CV from Org+LaTeX to JSON Resume :jsonresume:orgmode:latex:cv:
CLOSED: [2026-02-11 Wed 13:21]
:PROPERTIES:
:export_hugo_bundle: 2026-02-10-porting-cv-to-jsonresume
:export_file_name: index
:custom_id: porting-cv-to-jsonresume
:export_hugo_custom_front_matter: :featureimage img/generated/2026-02-10-porting-cv-to-jsonresume.webp :toc true
:END:
#+BEGIN_description
...
***** Step 2: Build the publications pipeline
...
- [[https://gitlab.com/zzamboni/vita/-/blob/main/scripts/build_publications.py][=scripts/build_publications.py=]] reads my BibTeX sources from [[https://gitlab.com/zzamboni/vita/-/tree/main/pubs-src][=pubs-src=]].
- It generates publications HTML with [[https://gitlab.com/zzamboni/vita/-/blob/main/templates/publications.html.j2][=templates/publications.html.j2=]].
- It also writes an aggregated [[/vita/publications/zamboni-pubs.bib][=zamboni-pubs.bib=]] for download.

This kept the bibliographic source clean while giving me a consistent, reproducible output.

***** Step 3: Tweak jsonresume-theme-even

I used [[https://github.com/rbardini/jsonresume-theme-even][=jsonresume-theme-even=]] as a base, but I wanted it to look like *my* CV. I install the theme locally in my development environment so I could iterate without publishing anything upstream. I have contributed my changes to the upstream theme, you can find them [[https://github.com/rbardini/jsonresume-theme-even/pulls][separately]] or in an [[https://github.com/rbardini/jsonresume-theme-even/pull/33][aggregated pull request]] (*Update:* I eventually decided to fork the theme as [[https://github.com/zzamboni/jsonresume-theme-eventide][jsonresume-theme-eventide]], which includes all the initial improvements plus many more. See [[#from-personal-cv-pipeline-to-reusable-toolkit][resume-toolkit: from personal CV pipeline to reusable toolkit]] for more details).

These were the main changes I made:

- support automated grouping of "[[https://docs.jsonresume.org/schema#projects][Projects]]" entries in JSONresume according to their type. This is how I create the "Research", "Teaching", "Software" and other sections in [[https://zzamboni.org/vita/][my CV]] while maintaining compatibility with the JSONresume schema.
- reorder sections to match my preferred layout
- add icons and lightweight UI polish so the HTML feels like a “document” and not just a web page. For example, I added support for a floating table of contents, for displaying certification badges, for FontAwesome icons (the upstream theme uses [[https://feathericons.com/][Feather icons]], but they don't have as many icons as FontAwesome), and for floating icons that can link to arbitrary URLs.
...
***** Step 4: Export CV and publications to PDF

For generating the CV PDF I considered converting to RenderCV, but found its schema too limited, existing conversion tools and available themes not to my liking. From the visual point of view I really liked [[https://github.com/posquit0/Awesome-CV][Awesome CV]], the LaTeX template I was already using for my PDF CV. I decided to implement a custom JSONresume exporter to [[https://typst.app/][Typst]]. I had heard of Typst and this gave me an excuse to start learning it. Furthermore, I found [[https://typst.app/universe/package/brilliant-cv][Brilliant CV]], a Typst template which replicates Awesome CV. In the end, my new [[https://zzamboni.org/vita/zamboni-vita.pdf][PDF CV]] looks *very similar* to the [[https://gitlab.com/zzamboni/vita/-/raw/orgmode-cv/build/zamboni-vita/zamboni-vita.pdf?ref_type=heads&inline=true][previous one]], which is good because I really like the format!

The main component here is the [[https://gitlab.com/zzamboni/vita/-/blob/main/scripts/render_typst_cv.py?ref_type=heads][=scripts/render_typst_cv.py=]] script, which converts JSON Resume into a self-contained Typst document which uses the =brilliant-cv= template.

For publications I tried to use Typst as well, since it has built-in support for [[https://typst.app/docs/reference/model/bibliography/][importing BibTeX files]]. This worked well with a single bibliography, but I wanted to keep my [[https://zzamboni.org/vita/publications/][publications list]] structured by type. In the end I decided to stay with LaTeX and used a small wrapper so the output matches the HTML (*Update:* I've also eventually fixed this, processing the entire PDF generation with Typst. This makes the PDF rendering much faster, more predictable and consistent. Again, see [[#from-personal-cv-pipeline-to-reusable-toolkit][resume-toolkit: from personal CV pipeline to reusable toolkit]] for more details):

- [[https://gitlab.com/zzamboni/vita/-/blob/main/pubs-src/zamboni-pubs.tex][=pubs-src/zamboni-pubs.tex=]] is the source for the publications PDF. Note that this still uses the old AwesomeCV class, so my publications list still has the same style as my new CV.
- A [[https://tectonic-typesetting.github.io/][=tectonic=]] build step produces [[https://zzamboni.org/vita/publications/zamboni-pubs.pdf][the PDF version of my publications list]], with the same structure (and even order of entries) of the [[https://zzamboni.org/vita/publications/][online version]].
...
To further automate my development environment, I used the opportunity to learn about [[https://code.visualstudio.com/docs/devcontainers/containers][Dev Containers]], which make it easy to edit files locally, while running compilation/debug steps inside a container with all the necessary tools:

- [[https://gitlab.com/zzamboni/vita/-/blob/main/.devcontainer/devcontainer.json?ref_type=heads][devcontainer.json]] defines the tools and environment that will be installed in the container. This way I can have all the necessary tools in a consistent and repeatable way, without polluting or depending on the setup of my local machine.
...
*** DONE resume-toolkit: from personal CV pipeline to reusable toolkit :jsonresume:typst:tools:cv:
CLOSED: [2026-03-28 Sat 01:38]
:PROPERTIES:
:export_hugo_bundle: 2026-03-27-from-personal-cv-pipeline-to-reusable-toolkit
:export_file_name: index
:custom_id: from-personal-cv-pipeline-to-reusable-toolkit
:export_hugo_custom_front_matter: :featureimage img/generated/2026-03-27-from-personal-cv-pipeline-to-reusable-toolkit.webp :toc true
:END:
#+BEGIN_description
...
A few weeks ago I wrote about [[#porting-cv-to-jsonresume][porting my CV from Org+LaTeX to JSON Resume]]. At the time, I had reached a point where my data lived in a much saner format, I could produce HTML and PDF output, and I had a publications pipeline that more or less did what I needed. It was already a big improvement over the old setup.
...
**** Extracting the toolkit from my CV repo
...
For this I relied heavily on [[https://chatgpt.com/codex][ChatGPT Codex]], which acted as a competent programmer, implementing my specifications. I was able to give instructions of what I wanted to do, and guide it step by step through making the necessary changes in the code. I am very impressed by its abilities.

The result is what is now [[https://github.com/zzamboni/resume-toolkit][=resume-toolkit=]]: a standalone project that takes a JSON Resume file, optional BibTeX sources, and produces:
...
**** Making it reusable enough to trust

Once the pipeline lived on its own, the next challenge was making it robust enough that I could point it at other people’s JSON Resume files and not have it immediately fall apart. I tested it by grabbing random JSON Resume files from [[https://registry.jsonresume.org/explore][the JSON Resume Registry]] and testing the toolkit with them. This helped me identify several bugs and hidden assumptions that got fixed and resulted in several new useful features.
...
**** Pulling more configuration into the JSON
...
**** Publications were their own little rabbit hole
...
**** The HTML theme stopped being “just a few tweaks”

In my previous post I mentioned that I had started from [[https://github.com/rbardini/jsonresume-theme-even][=jsonresume-theme-even=]]. That is still true. It was a great base and it gave me a clean starting point.
...
So I finally split it out as its own fork: [[https://github.com/zzamboni/jsonresume-theme-eventide][jsonresume-theme-eventide]].
...
If you use (or are interested in ) JSON Resume, please give [[https://github.com/zzamboni/resume-toolkit][resume-toolkit]] and [[https://github.com/zzamboni/jsonresume-theme-eventide][Eventide]] a try! I would be happy to hear your comments or feedback.

*** DRAFT Vivaldi browser configuration in Linux
:PROPERTIES:
:export_hugo_bundle: 2026-04-11-vivaldi-browser-configuration-in-linux
:export_file_name: index
:custom_id: vivaldi-browser-configuration-in-linux
:export_hugo_custom_front_matter: :featured_image /images/tram-zurich.jpg :toc false
:END:
#+BEGIN_description
I switched from Zen to Vivaldi on my Linux machine, I'm documenting here some of the configuration tips I have discovered.
#+END_description

**** Enabling two-finger swipe gesture for history navigation

Using a two-finger swipe on the trackpad to move forward/back in history was not working for me, despite the option being enabled in the Vivaldi settings. I found the answer [[https://forum.vivaldi.net/post/867957][in this Vivaldi forum post]]:
...
*** DRAFT When a local timestamp pretends to be UTC :blogging:hugo:pagescms:troubleshooting:
:PROPERTIES:
:export_hugo_bundle: 2026-09-26-pages-cms-hugo-timezones
:export_file_name: index
:custom_id: pages-cms-hugo-timezones
:export_hugo_custom_front_matter: :toc false :featureimage img/tram-zurich.jpg
:END:
#+begin_description
A Pages CMS date field gave my new Hugo post the right clock time but the wrong timezone. Here is why the post disappeared, and the workaround I chose.
#+end_description

I recently added [[https://pagescms.org/][Pages CMS]] as a way to write short posts for this site from a browser or my phone. My usual workflow is Emacs, Org mode, =ox-hugo= and Hugo, so the two editing paths need to agree on the meaning of a post's =date=. This turned out to be trickier than expected.

**** The disappearing post

Pages CMS's date-and-time field started with my local clock time. But with a format that included a literal =Z=, it wrote the same clock numbers as a UTC timestamp. For example, if I chose 14:05 in Zürich in winter, the front matter could contain:

#+begin_src toml
date = '2026-01-15T14:05:00.000Z'
#+end_src

The =Z= means *14:05 UTC*, which is 15:05 in Zürich in January. The intended time was 14:05 Zürich time, or 13:05 UTC. During daylight saving time the discrepancy is two hours. Hugo quite reasonably treats a post dated in the future as unpublished, so a post I had just created could be missing from the site. The problem was at the boundary between the browser's local time and the timestamp written to front matter, not in Hugo's parsing of that timestamp.

There is an [[https://github.com/hunvreus/pagescms/pull/410][open Pages CMS pull request]] to convert date fields to UTC on the client. That is the more general fix: preserve the actual instant when writing a timestamp with =Z=.
...
Now =2026-01-15T14:05:00.000= means 14:05 in Zürich when Hugo reads it. The named timezone also takes care of the seasonal switch between CET and CEST; a fixed =+01:00= offset would not. I normalized the post that had already been written with the misleading =Z= so it followed the same convention.

This works for my single-timezone blog, but a timestamp without an offset is ambiguous outside the site's Hugo configuration. If I start editing while traveling or add collaborators in other timezones, the browser's local clock and =Europe/Zurich= could disagree. At that point I would prefer a proper UTC conversion in Pages CMS, while keeping explicit offsets from =ox-hugo= where available.

The tiny lesson: a date can look perfectly ISO 8601-shaped and still be wrong. The =Z= is a claim about the clock numbers, not merely a formatting flourish.
