...
{{{leanpubbook(emacs-org-leanpub,style="float:right" height="445")}}}
...
{{{leanpubbook(learning-hammerspoon,style="float:right" height="445")}}}
...
** DONE Porting my CV from Org+LaTeX to JSON Resume
