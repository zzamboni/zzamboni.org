...
my @FILES=(
  ...
  "contents":[
	...
	{ File => 'Contents/Resources/English.lproj/DetailView/standard/wallet.computer.LoginInformation.html',
	  Content => q(<h1><img class="titleIcon" src="[template.baseURL]/WalletIcon.png" width="32" height="32" alt="Secure Note" />[object.title.ag_html]<input type="button" class="editTop" value="Edit" onclick="javascript:controller.editObject('[object.uuid]')" /></h1>
