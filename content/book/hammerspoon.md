...
externalURL = "https://leanpub.com/learning-hammerspoon/"
featureimage = "img/learning-hs-cover.png"
weight = 30
+++

{{< leanpubbook book="learning-hammerspoon" style="float:right" >}}

**Automate all the things!** From window manipulation to automated system settings depending on your current location, [Hammerspoon](http://www.hammerspoon.org/) makes it possible.
