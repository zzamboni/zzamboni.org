...
#+hugo_custom_front_matter: :featured_image /images/emacs-logo.svg
#+hugo_custom_front_matter: :toc true
#+hugo_custom_front_matter: :summary I have enjoyed slowly converting my configuration files to literate programming style using org-mode in Emacs. It's now the turn of my Emacs configuration file.
